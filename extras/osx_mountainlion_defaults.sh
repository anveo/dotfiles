...
sudo scutil --set ComputerName "roadhouse"
sudo scutil --set HostName "roadhouse"
sudo scutil --set LocalHostName "roadhouse"
defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "roadhouse"
